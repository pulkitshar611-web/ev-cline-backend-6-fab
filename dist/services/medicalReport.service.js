...
export const medicalReportService = {
    ...
    async createReport(data) {
        ...
        if (data.sickLeaveFrom)
            createData.sickLeaveFrom = new Date(data.sickLeaveFrom);
        if (data.sickLeaveTo)
            createData.sickLeaveTo = new Date(data.sickLeaveTo);
    ...
    async getReportsByDoctor(doctorId, clinicId) {
        return prisma.medical_report.findMany({
    ...
    async getReportsByPatientEmail(email) {
    ...
    async updateReport(id, data) {
        ...
        if (data.sickLeaveFrom)
            updateData.sickLeaveFrom = new Date(data.sickLeaveFrom);
        if (data.sickLeaveTo)
            updateData.sickLeaveTo = new Date(data.sickLeaveTo);
        if (data.reportDate)
