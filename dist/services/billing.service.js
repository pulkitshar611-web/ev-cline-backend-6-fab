...
const syncInvoiceItemsPayment = async (tx, invoiceId) => {
...
export const getPendingBillingItems = async (clinicId, patientId) => {
...
export const updateInvoiceStatus = async (clinicId, id, status, paymentMethod) => {
